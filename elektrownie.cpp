...
void paski(int k, elektrownia &e, weather &w)
{
	double ekologia = (e.eko + e.dlugo)/2;
	ekologia = ekologia*10;
	cout << "Ekologia- " << ekologia << "%" << endl;
	double energia = k * 10;
	cout << "Energia- " << energia << "%" << endl;
	double reputacja = (k*(e.eko + e.dlugo)/2) - e.koszt;
	cout << "Reputacja- " << reputacja << "%" << endl;
}
